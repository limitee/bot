...
uses Windows, Classes, Controls, Forms, Dialogs, DesignIntf,DesignEditors,
...
procedure Register;
begin
  RegisterComponents('AutoUpgrader', [TauAutoUpgrader, TauHTTP, TauThread {, TauExtAssociation}]);
